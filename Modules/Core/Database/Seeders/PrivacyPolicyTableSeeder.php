...
class PrivacyPolicyTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('psx_core_privacy_policies')->insert([
            'content' => '<p><strong>Privacy Policy</strong></p>

<p>Panacea-Soft built the Flutter BuySell app as a Free app. This SERVICE is provided by Panacea-Soft at no cost and is intended for use as is.</p>
...
<p>For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to Panacea-Soft. The information that we request will be retained by us and used as described in this privacy policy.</p>
