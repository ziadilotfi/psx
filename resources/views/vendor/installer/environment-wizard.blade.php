        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('environment') ? ' has-error ' : '' }}">
                    ...
                    <select name="environment" id="environment" onchange='checkEnvironment(this.value);'>
                        <option value="local" {{ config('app.env') == 'local' ? 'selected' : '' }}>{{ trans('installer_messages.environment.wizard.form.app_environment_label_local') }}</option>
                        ...
                        <option value="production" {{ config('app.env') == 'production' ? 'selected' : '' }}>{{ trans('installer_messages.environment.wizard.form.app_environment_label_production') }}</option>
                ...
                <div class="form-group {{ $errors->has('app_debug') ? ' has-error ' : '' }}">
                    ...
                    <label for="app_debug_true">
                        <input type="radio" name="app_debug" id="app_debug_true" value=true {{ config('app.debug') ? 'checked' : '' }} />
                        {{ trans('installer_messages.environment.wizard.form.app_debug_label_true') }}
                    </label>
                    <label for="app_debug_false">
                        <input type="radio" name="app_debug" id="app_debug_false" value=false {{ config('app.debug') ? '' : 'checked' }} />
                ...
                <div class="form-group {{ $errors->has('app_dir') ? ' has-error ' : '' }}">
                    <label for="app_dir">
                        APP Dir
                    </label>
                    <input type="text" name="app_dir" id="app_dir" value="{{ config('app.dir') }}" placeholder="Enter App Dir" />
                    @if ($errors->has('app_dir'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('app_dir') }}
                        </span>
                    @endif
                </div>
                ...
                {{-- <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="{{ config('app.url') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('base_domain') ? ' has-error ' : '' }}">
                    <input type="hidden" name="app_url" value="{{ config('app.base_domain') }}">
                    <label for="base_domain">
                        {{ trans('installer_messages.environment.wizard.form.base_domain_label') }}
                    </label>
                    <input type="url" name="base_domain" id="base_domain" value="{{ config('app.base_domain') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.base_domain_placeholder') }}" />
                    @if ($errors->has('base_domain'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('base_domain') }}
                        </span>
                    @endif
                </div>
                ...
                <div class="buttons">
                    @if(count($errors) > 0)
                        <button class="button" onclick="showDatabaseSettings();return false" style="background-color: #ef4444;">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_hostname" id="database_hostname" value="{{ config('database.connections.mysql.host') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_host_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_port') ? ' has-error ' : '' }}">
                    ...
                    <input type="number" name="database_port" id="database_port" value="{{ config('database.connections.mysql.port') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_port_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_name" id="database_name" value="{{ config('database.connections.mysql.database') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_username" id="database_username" value="{{ config('database.connections.mysql.username') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_username_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="password" name="database_password" id="database_password" value="{{ config('database.connections.mysql.password') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_password_placeholder') }}" />
