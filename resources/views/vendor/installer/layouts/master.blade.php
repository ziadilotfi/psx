...
<html>
    ...
    <body>
        <div class="master">
            <div class="box">
                <div class="header">
                    <img src="{{ asset('installer/img/ps-logo.jpg') }}" width="50" height="50" class="header__logo"/>
                    <h1 class="header__title">@yield('title')</h1>
                </div>
                <ul class="step">
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::final') }}">
                        <i class="step__icon fa fa-check-circle-o" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::userConfiguration') }}">
                        @if(!Request::is('install/userConfiguration') && !Request::is('install/purchasedCode') && !Request::is('install'))
                            <a href="{{ route('LaravelInstaller::userConfiguration') }}">
                                <i class="step__icon fa fa-sign-in" aria-hidden="true"></i>
                            </a>
                        @else
                            <i class="step__icon fa fa-sign-in" aria-hidden="true"></i>
                        @endif
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::purchasedCode') }}">
                        @if(!Request::is('install/purchasedCode') && !Request::is('install'))
                            <a href="{{ route('LaravelInstaller::purchasedCode') }}">
                                <i class="step__icon fa fa-shield" aria-hidden="true"></i>
                            </a>
                        @else
                            <i class="step__icon fa fa-shield" aria-hidden="true"></i>
                        @endif
                    ...
                    <li class="step__item {{ isActive('LaravelInstaller::welcome') }}">
                        @if(!Request::is('install'))
                            <a href="{{ route('LaravelInstaller::welcome') }}">
                                <i class="step__icon fa fa-download" aria-hidden="true"></i>
                            </a>
                        @else
                            <i class="step__icon fa fa-download" aria-hidden="true"></i>
                        @endif
